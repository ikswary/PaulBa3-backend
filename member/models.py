...
class ClausesConfirmation(models.Model):
    ...
    clausers_id = models.ForeignKey(
        'ClausesOption', on_delete=models.SET_NULL, null=True)
    confirm = models.BooleanField()

    class Meta:
        db_table = 'clauses_confirm'
...
class Inquirement(models.Model):
